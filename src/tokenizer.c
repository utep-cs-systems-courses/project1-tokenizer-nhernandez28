...
/* Return true (non-zero) if c is a whitespace character ('t' or ' '). 
...
word in zero-terminated str. Return a zero if str does not contain any words. */
...
/* Counts the number of words in the sting argument. */
...
char **tokenize(char *str)
{
  ...
  //int i goes through each strin user inputs.
